# -*- coding: utf-8 -*-
"""
Created on Wed Nov 24 12:42:58 2021
...
comp1 = signature(r'C:\Users\hp\Desktop\crypto project\Land_1.txt',p,q,g,x)

argv.append(buffer(comp1[0],comp1[1],'Yash Dahiya'))
#print("test----r-", argv[0].r)
comp2 = signature(r'C:\Users\hp\Desktop\crypto project\Land_2.txt',p,q,g,x)
